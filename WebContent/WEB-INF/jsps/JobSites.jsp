...
<a href='${pageContext.request.contextPath}/JobSites' class="link current">Job Sites</a>
...
<li><a href="http://www.naukri.com/">Naukari</a>
...
<div class="popup-wrapper" id="popup">
				...
				<div id="group">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Naukari"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<input type="submit" value="Save">
				</p>
				</div>
				<div><a class="popup-close" href="#closed">X</a></div>
				</form>
				</div>
				</div>
...
<div class="popup-wrapper" id="popup0">
				...
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>				<p> 
				<input type="submit" value="Save">
				</p>
				</div>
				<div>
...
<li><a href="http://www.monsterindia.com/">Monster</a>
...
<li><a href="http://www.careerbuilder.com/">Career builder</a>
				<a href="http://www.careerbuilder.com/" class="pic">
				<img src="img/Careerbuilder.png"></a>

<a href="#popup2" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup2">
				<div class="popup-container">
				<form id="form2" action=" method="post">
				<strong>Career builder</strong></p>
				<div id="group2">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="CareerBuilder"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.simplyhired.co.in/">Simply hire</a>
				<a href="http://www.simplyhired.co.in/" class="pic">
				<img src="img/Sipmlple hire.png"></a>

<a href="#popup3" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup3">
				<div class="popup-container">
				<form id="form3" action="save" method="post">
				<strong>Sipmlple hire</strong></p>
				<div id="group3">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="SimplyHire"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="https://www.freshersworld.com/">Freshers world</a>
				<a href="https://www.freshersworld.com/" class="pic">
				<img src="img/Freshers world.png"></a>
	
<a href="#popup4" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup4">
				<div class="popup-container">
				<form id="form4" action="save" method="post">
				<strong>Freshers world</strong></p>
				<div id="group4">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="FreshersWorld"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.bigfoot.com/">Big foot</a>
				<a href="http://www.bigfoot.com/" class="pic">
				<img src="img/Big foot.jpg"></a>
				
<a href="#popup5" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup5">
				<div class="popup-container">
				<form id="form5" action="save" method="post">
				<strong>Big foot</strong></p>
				<div id="group5">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="BinFoot"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.bitra.com/">Bitra</a>
				<a href="http://www.bitra.com/" class="pic">
				<img src="img/Bitra.jpg"></a>
				
<a href="#popup6" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup6">
				<div class="popup-container">
				<form id="form6" action="save" method="post">
				<strong>Bitra</strong></p>
				<div id="group6">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Bitra"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://careermarshal.com/">career marshal</a>
				<a href="http://careermarshal.com/" class="pic">
				<img src="img/career marshal.png"></a>
				
<a href="#popup7" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup7">
				<div class="popup-container">
				<form id="form7" action="save" method="post">
				<strong>career marshal</strong></p>
				<div id="group7">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="CareerMarshal"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://careerlink.com/">career link</a>
				<a href="http://careerlink.com/" class="pic">
				<img src="img/career link.jpg"></a>
				
<a href="#popup8" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup8">
				<div class="popup-container">
				<form id="form8" action="save" method="post">
				<strong>career link</strong></p>
				<div id="group8">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="CareerLink"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="https://www.cia.gov/careers/opportunities/cia-jobs">career oppnity</a>
				<a href="https://www.cia.gov/careers/opportunities/cia-jobs" class="pic">
				<img src="img/career opportunities.jpg"></a>
...
<div class="popup-wrapper" id="popup9">
				...
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="CareerOpportunities"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.dice.com/">Dice</a>
				<a href="http://www.dice.com/" class="pic">
				<img src="img/dice.jpg"></a>
				
<a href="#popup10" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup10">
				<div class="popup-container">
				<form id="form10" action="save" method="post">
				<strong>Dice</strong></p>
				<div id="group10">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Dice"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.indeed.com/q-Flair-jobs.html">Flair job</a>
				<a href="http://www.indeed.com/q-Flair-jobs.html" class="pic">
				<img src="img/Flair job.png"></a>

<a href="#popup11" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup11">
				<div class="popup-container">
				<form id="form11" action="save" method="post">
				<strong>Flair job</strong></p>
				<div id="group11">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="FlairJob"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.freshersopenings.in/">job openings</a>
				<a href="http://www.freshersopenings.in/" class="pic">
				<img src="img/job openings.jpg"></a>
				
<a href="#popup12" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup12">
				<div class="popup-container">
				<form id="form12" action="save" method="post">
				<strong>job openings</strong></p>
				<div id="group12">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="JobOpenings"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://in.jobrapido.com/">job rapido</a>
				<a href="http://in.jobrapido.com/" class="pic">
				<img src="img/job rapido.jpg"></a>
				
<a href="#popup13" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup13">
				<div class="popup-container">
				<form id="form13" action="save" method="post">
				<strong>job rapido</strong></p>
				<div id="group13">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="JobRapido"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.jobseeker.com/">Job seeker</a>
				<a href="http://www.jobseeker.com/" class="pic">
				<img src="img/job seeker.jpg"></a>
				
<a href="#popup14" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup14">
				<div class="popup-container">
				<form id="form14" action="save" method="post">
				<strong>Job seeker</strong></p>
				<div id="group14">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="JobSeeker"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://jobzhut.com/">Jobzhut</a>
				<a href="http://jobzhut.com/" class="pic">
				<img src="img/jobzhut.png"></a>
				
<a href="#popup15" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup15">
				<div class="popup-container">
				<form id="form15" action="save" method="post">
				<strong>Jobzhut</strong></p>
				<div id="group15">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Jobzhut"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="https://in.linkedin.com/">Linked in</a>
				<a href="https://in.linkedin.com/" class="pic">
				<img src="img/linked in.jpg"></a>
...
<div class="popup-wrapper" id="popup16">
				...
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Linkedin"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.quikr.com/jobs">Quikr jobs</a>
				<a href="http://www.quikr.com/jobs" class="pic">
				<img src="img/Quikr jobs.jpg"></a>
				
<a href="#popup17" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup17">
				<div class="popup-container">
				<form id="form17" action="save" method="post">
				<strong>Quikr jobs</strong></p>
				<div id="group17">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Quikrjobs"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.sinojobs-careerdays.com/en/">Sinojobs</a>
				<a href="http://www.sinojobs-careerdays.com/en/" class="pic">
				<img src="img/Sinojobs.png"></a>
				
<a href="#popup18" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup18">
				<div class="popup-container">
				<form id="form18" action="save" method="post">
				<strong>Sinojobs</strong></p>
				<div id="group18">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Sinojobs"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.talentpegs.com/">talent pegs</a>
				<a href="http://www.talentpegs.com/" class="pic">
				<img src="img/talent pegs.png"></a>
				
<a href="#popup19" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup19">
				<div class="popup-container">
				<form id="form19" action="save" method="post">
				<strong>talent pegs</strong></p>
				<div id="group19">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="TalentPegs"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>				<p> 
				<input type="submit" value="Save">
				</p>
				</div>
...
<li><a href="http://www.timesjobs.com/">TimesJobs</a>
				<a href="http://www.timesjobs.com/" class="pic">
				<img src="img/TimesJobs.jpg"></a>
				
<a href="#popup20" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup20">
				<div class="popup-container">
				<form id="form20" action="save" method="post">
				<strong>TimesJobs</strong></p>
				<div id="group20">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Timesjobs"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.wisdomjobs.com/">Wisdom</a>
				<a href="http://www.wisdomjobs.com/" class="pic">
				<img src="img/Wisdom.png"></a>
				
<a href="#popup21" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup21">
				<div class="popup-container">
				<form id="form21" action="save" method="post">
				<strong>Wisdom</strong></p>
				<div id="group21">
			<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Wisdom"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.babajob.com/">Babajobs</a>
				<a href="http://www.babajob.com/" class="pic">
				<img src="img/Babajobs.jpg"></a>
				
<a href="#popup22" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup22">
				<div class="popup-container">
				<form id="form22" action="save" method="post">
				<strong>Babajobs</strong></p>
				<div id="group22">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Babajobs"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.bdjobs.com/">Bdjobs</a>
				<a href="http://www.bdjobs.com/" class="pic">
				<img src="img/Bdjobs.png"></a>
				
<a href="#popup23" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup23">
				<div class="popup-container">
				<form id="form23" action="save" method="post">
				<strong>Bdjobs</strong></p>
				<div id="group23">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Bdjobs"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
		...
		<a href="#popupy" class="popup-link24">Show</a>
				...
				<div class="popup-container">
				<form id="formy" action="save" method="post">
				<strong>Enter Your Login OTP </strong></p>
				<div id="groupy">
				<p><input type="text" name="otp" placeholder="Enter Otp Nuber"></p>
				<p><input type="hidden" name="accoType" value="Bdjobs"></p>
...
<li><a href="Freshersnow.com">Freshersnow</a>
				<a href="Freshersnow.com" class="pic">
				<img src="img/Freshersnow.jpg"></a>
				
<a href="#popup24" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup24">
				<div class="popup-container">
				<form id="form24" action="save" method="post">
				<strong>Freshersnow</strong></p>
				<div id="group24">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Freshersnow"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.rblbank.com/">Rblban</a>
				<a href="http://www.rblbank.com/" class="pic">
				<img src="img/Rblbank.png"></a>
				
<a href="#popup25" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup25">
				<div class="popup-container">
				<form id="form25" action="save" method="post">
				<strong>Rblbank</strong></p>
				<div id="group25">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Rblbank"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
...
<li><a href="http://www.sarkariresult.com/">Sarkari</a>
				<a href="http://www.sarkariresult.com/" class="pic">
				<img src="img/Sarkari.jpg"></a>
				
<a href="#popup26" class="popup-link">Save</a>
<div class="popup-wrapper" id="popup26">
				<div class="popup-container">
				<form id="form26" action="save" method="post">
				<strong>Sarkari</strong></p>
				<div id="group26">
				<input type="text" name="apsUserName" placeholder="Email Address"></p>
				<p><input type="password" name="apsPassword" placeholder="Password"></p>
				<p><input type="hidden" name="accoType" value="Sarkari"></p>
				<p><input type="hidden" name="mobile" value="<%=session.getAttribute("mail")%>"></p>
				<p> 
				<input type="submit" value="Save">
				</p>
